...
namespace APIVerve
{
    public class HTMLtoPDFAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/htmltopdf";
        ...
        public HTMLtoPDFAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public HTMLtoPDFAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HTMLtoPDFQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(HTMLtoPDFQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(HTMLtoPDFQueryOptions options)
        {
